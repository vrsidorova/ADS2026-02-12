...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        while (priorityQueue.size() > 1) {
            Node left = priorityQueue.poll(); // вынимаем наименьший
            Node right = priorityQueue.poll(); // вынимаем второй наименьший
            priorityQueue.add(new InternalNode(left, right)); // создаём родителя и кладём обратно
        }
